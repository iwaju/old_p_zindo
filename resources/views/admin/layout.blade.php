        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
           ...
           <!-- Links -->
            ...
            <!-- Links -->
            <li @if(Request::is('panel/admin/proposed-projects*')) class="active" @endif>
              <a href="{{ url('panel/admin/proposed-projects/') }}"><i class="fa fa-wpforms"></i> <span>{{ trans('misc.proposed_projects') }}</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
               <li @if(Request::is('panel/admin/gallery/photos*')) class="active" @endif><a href="{{ route('proposed-projects-list') }}"><i class="fa fa-list"></i> {{ trans('misc.list') }}</a></li>
             </ul>
            </li><!-- ./Links -->
            ...
            <!-- Links -->
            <li @if(Request::is('panel/admin/forum')) class="active" @endif>
              <a href="{{ url('panel/admin/forum') }}"><i class="fa fa-comments"></i> <span>{{ trans('misc.forum') }}</span></a>
            </li><!-- ./Links -->
