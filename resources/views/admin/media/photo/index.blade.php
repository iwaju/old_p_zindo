        ...
        <section class="content-header">
          <h4 class="small">
            <ol class="breadcrumb">
              ...
              <li class="active">{{ trans('misc.photo_album') }}</li>
            </ol>
          </h4>
        </section>
        ...
        <section class="content">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="{{ route('photos-albums', ['id'=>$album->id]) }}"><i class="fa fa-folder-o"></i> {{ ucfirst($album->name) }} <span class="label label-danger pull-right">{{ count( $album->images ) }}</span></a>
                    </li>
                    @endforeach
                  </ul>
                </div>
            ...
            <div class="col-md-9 col-xs-12">
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">{{ trans('misc.photo_album') }}</h3>
